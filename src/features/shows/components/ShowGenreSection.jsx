...
// // Updated with TV-specific TMDB Genre IDs where necessary
// const TV_CATEGORIES = [
...
// // TMDB TV show discover endpoint
...
//               }
//               // TV Shows use show.name instead of show.title
//               alt={show.name} 
...
//         <div className="absolute bottom-0 left-0 right-0 flex items-center justify-between px-6 py-2 z-10">
...
//         <h2 className="text-white text-3xl font-bold">Our Genres</h2>
...
//           <ShowGenreCard key={category.id} category={category} />
//         ))}
//       </div>
//     </section>
//   );
...
// export default ShowGenresSection;
...
const ShowGenresSection = () => {
  ...
  return (
    <section id="show-genres" className="bg-[#141414] px-4 sm:px-6 lg:px-12 xl:px-20 py-12 sm:py-16 lg:py-20">
