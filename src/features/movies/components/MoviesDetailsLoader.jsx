...
const MoviesDetailsLoader = () => {
  return (
    <div className="min-h-screen bg-[#141414] flex items-center justify-center">
      <div className="flex flex-col items-center gap-6">
        {/* SVG Logo — pulse animation */}
        <div style={{ animation: "logo-pulse 1.5s ease-in-out infinite" }}>
          <svg
            width="60"
            height="60"
            viewBox="0 0 60 60"
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M24.6289 24.6828C24.6289 23.4735 25.9255 22.7068 26.9851 23.2897L36.7715 28.6721C37.8698 29.2762 37.8698 30.8544 36.7715 31.4585L26.9851 36.841C25.9255 37.4238 24.6289 36.6571 24.6289 35.4478V24.6828Z"
              fill="white"
            />
          </svg>
        </div>
        ...
        <div className="flex flex-col items-center gap-2">
          <p className="text-white font-semibold text-base tracking-wider uppercase">
            Loading
          </p>
  ...
  0%, 100% {
    transform: scale(1);
    filter: drop-shadow(0 0 0px #e60000);
  }
  50% {
    transform: scale(1.08);
    filter: drop-shadow(0 0 4px #e60000);
  }
}
      `}</style>
    </div>
...
export default MoviesDetailsLoader;
